...
function AdminDashboard() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get("/api/user/admin-dashboard-data", {
          headers: {
        ...
        const calculatePercentageChange = (todayValue, yesterdayValue) => {
          if (yesterdayValue === 0) return 0; // Avoid division by zero
        ...
        // Set monthly data and percentage changes
        setMonthlyData({
          totalSales,
          totalProfit,
          totalCredit,
          ...
          {[
            {
              ...
              percentage: monthlyData.salesPercentageChange,
            },
            {
              title: "Total Profit",
              value: monthlyData.totalProfit,
              percentage: monthlyData.profitPercentageChange,
            },
            {
              title: "Total Credit",
              value: monthlyData.totalCredit,
              percentage: monthlyData.creditPercentageChange,
            },
            {
              title: "Total Expense",
              value: monthlyData.totalExpense,
              percentage: monthlyData.expensePercentageChange,
            },
          ].map((item, index) => (
            <motion.div
              key={index}
